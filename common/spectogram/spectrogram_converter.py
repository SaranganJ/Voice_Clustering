...
from common.spectogram.spectrogram_png_safer import *
...
def mel_spectrogram(wav_file):
    ...
    #print("------------------>>>>>>>>>>>  shape audio range\n")
    #print(audio_range.shape)
    # print("------------------>>>>>>>>>>>  audio range\n")
    # print(audio_range)
    # print("------------------>>>>>>>>>>>  array size\n")
    ...
    #print("------------------>>>>>>>>>>>  Librosa return spectra size\n")
    #print(mel_spectrogram.shape)

    #save_spectrogram(mel_spectrogram)
